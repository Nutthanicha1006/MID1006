...
namespace Mid3flowerStore
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            SelectNum(decide, flowerStore);
            Decide(decide, flowerStore);

            Console.ReadLine();
        }

        static void SelectNum(string decide, FlowerStore flowerStore)
        {
            string selectFlower;
        ...
        static void Decide (string decide, FlowerStore flowerStore)
        {
